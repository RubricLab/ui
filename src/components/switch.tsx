...
>(({ className, ...props }, ref) => (
	...
	>
		<SwitchPrimitives.Thumb
			className={clsx(
				'pointer-events-none mx-[0.05rem] block size-4 rounded-full bg-rubricui-contrast/50 shadow-lg ring-0 transition-transform duration-rubricui-duration data-[state=checked]:w-[20px] data-[state=checked]:translate-x-3 data-[state=unchecked]:translate-x-0 data-[state=checked]:bg-rubricui-contrast'
			)}
		/>
	</SwitchPrimitives.Root>
))
