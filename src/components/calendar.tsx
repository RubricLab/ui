...
function Calendar({ className, classNames, showOutsideDays = true, ...props }: CalendarProps) {
	...
	return (
		<DayPicker
			...
			className={cn('border border-rubricui-contrast/10 p-3', className)}
			classNames={{
				months: 'relative',
				month: 'space-y-4',
				...
				weekdays: 'flex',
				weekday: 'text-rubricui-contrast rounded-md w-9 font-normal text-[0.8rem]',
				...
				range_middle: 'aria-selected:bg-rubricui-contrast/20 aria-selected:text-rubricui-contrast',
				hidden: 'invisible',
				...classNames
			}}
			components={{
